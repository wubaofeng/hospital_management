...
<form class="definewidth m20" enctype="multipart/form-data">
    ...
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="simpleDescription" value=""/></td>
        </tr>
        ...
        <tr>
            ...
            <td><textarea name="detailedDescription"></textarea></td>
        </tr>
        <tr>
            <td width="10%" class="tableleft">生产厂商</td>
            <td><textarea name="productFirm"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <center>
                    <button type="button" id="medicine-add-submit" class="btn btn-primary" type="button">保存</button>
                    &nbsp;&nbsp;
...
<script>
    $(function () {
        $("#medicine-add-submit").click(function () {
