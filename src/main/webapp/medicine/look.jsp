...
<head>
    ...
    $(function () {       
		$('#backid').click(function(){
				window.location.href="${path}medicine?method=findAll";
		 });
    });
    </script>
</head>
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><img src="${medicine.picture}" width="50px" height="50px"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>${medicine.detailedDescription}</td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">生产厂商</td>
        <td>${medicine.productFirm}</td>
    </tr>
    <tr>
