...
<form method="post" class="definewidth m20">
    <input name="method" value="addRegister" type="hidden">
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="text" name="socialSecurityNumber" value=""/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <center>
                    <button type="button" class="btn btn-primary" onclick="addRegister()">保存</button> &nbsp;&nbsp;<button
...
<script>
    loadDoctorByDepartment(1);

    function addRegister() {
        $.post("${path}register", $("form").serialize(), function (data) {
            if (data) {
                alert("挂号信息已提交");
